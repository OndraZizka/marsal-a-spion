...
CREATE TABLE marsal.ms_typyfigur_pohyb (
  ...
  flags SET('X_NEK', 'Y_NEK', 'PRESKOK', 'UTOK') NOT NULL,
...
DROP TABLE IF EXISTS marsal.ms_pravidla;
CREATE TABLE marsal.ms_pravidla (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
	nazev CHAR(63) NOT NULL,
  id_sada TINYINT UNSIGNED NOT NULL,
  poli_x TINYINT UNSIGNED NOT NULL,
  poli_y TINYINT UNSIGNED NOT NULL,
  PRIMARY KEY (id)
)
ENGINE = InnoDB
CHARACTER SET cp1250 COLLATE general_ci;
