...
function go(){ document.forms[0].xbf.value="";
...
<table>
	...
	<tr height="60%"><td>Rozestav si armádu a zahaj hru. Tipy:
		...
		Nedávej všechny průzkumníky dopředu. Minéry dej přibližně doprostřed. Maršála doprovázej špiónem. A na další triky si přiď sám.
	</td></tr>
	<form action="marsal.php3" method="post">
	...
	<input type="hidden" name="xkdo" value="<?echo $xkdo;?>">
	<input type="hidden" name="xskym" value="<?echo $xskym;?>">
	<input type="hidden" name="xgamename" value="<?echo $xgamename;?>">
	</form>
